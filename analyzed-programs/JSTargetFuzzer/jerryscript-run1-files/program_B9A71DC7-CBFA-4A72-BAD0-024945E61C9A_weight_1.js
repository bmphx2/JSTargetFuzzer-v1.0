const t0 = [-268435456,54637,-9007199254740992,-2023801775,2147483648,-46097,268435439,-100925680,-24599];
t0.length = 1142439131;
for (let v7 = 0; v7 < 5; v7++) {
    try { Reflect.ownKeys(v7); } catch (e) {}
}
class C13 {
    [127];
    [-1];
...
function F15(a17, a18, a19, a20) {
    ...
    function f25(a26, a27) {
        Object.defineProperty(a26, "c", { writable: true, get: f24, set: f24 });
        return f24;
    }
    this.e = a17;
    RangeError(1024);
...
new F15(-1024n, -4, -40027n, -1024n);
new F15(-40027n, 1024, 1154383870n, 1154383870n);
new F15(-1024n, 1024, -40027n, -1024n);
