...
new F3(-8136, -4294967295);
new F3(-4294967295, 4096);
[0.6951679966919921,-6.807995963765709,1e-15,-912140.9709761619,1000000.0];
[3.0593653846703797e+307];
[-1.5212450082190372e+307,-2.0,3.0,-4.465648693452094,2.220446049250313e-16,-1.0,0.9830514325941142,5.0,2.0];
const v18 = new Float32Array(3701);
const v21 = new Int32Array();
const v22 = new Int32Array(v7, v18, v21);
function F23(a25) {
    if (!new.target) { throw 'must be called with new'; }
    this.f = v22;
    this.e = v21;
...
new Float32Array(0, F3, -1548605810, v26);
let v30 = [-Infinity];
const o33 = {
    set a(a32) {
    },
