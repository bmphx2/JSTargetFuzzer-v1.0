[1335560744,-8,4];
const v1 = [-4294967295,268435456,-268435456,1000];
const v2 = [-271445272,613837193,6,38203];
function f3() {
    return v2;
}
function f4(a5) {
    const o11 = {
        [v1](a7, a8) {
            Object.defineProperty(a8, this, { enumerable: true, get: f3, set: f3 });
            new Date();
            return a5;
        },
        "g": f3,
...
f4(v1);
f4(v1);
[1297353198,443427178,-60454,65535,9007199254740991];
[1339917530];
[-66917274,0,11195,65536,127,-35464,1756834199,268435439,536870888];
