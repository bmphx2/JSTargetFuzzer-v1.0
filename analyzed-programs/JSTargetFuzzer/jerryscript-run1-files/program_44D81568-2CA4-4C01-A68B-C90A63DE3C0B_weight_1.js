...
v4.toString = v5;
v3[536870889];
const v12 = new Uint8Array(1931);
new Uint8ClampedArray(64);
new BigUint64Array(37);
[-4294967295,0,9007199254740992,-1513875687,268435441];
[13044,-1513503152,16,4679];
[-1369202312,12,4294967297];
new Float32Array(3701, Float32Array);
const v27 = new resourceName();
const v28 = new resourceName();
v12[512] <<= 3701;
let v29 = -256;
function F35(a37) {
    if (!new.target) { throw 'must be called with new'; }
...
try {
    Object.defineProperty(v41, -2147483649, { configurable: true, set: Symbol });
} catch(e43) {
}
new Float32Array(0);
[-Infinity];
...
new Uint8Array(v55, Float32Array);
let v59 = -41990;
const v60 = v56++;
let v61 = --v59;
function f62() {
