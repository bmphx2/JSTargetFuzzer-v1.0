...
const v4 = new F0();
const v5 = new F0();
[3,7,1826113900,268435441,255,-12,-128,-458159123,1073741825,-1214313409];
[2147483647,2,0,-1829601212,-64429,-9223372036854775808,21292,-1128163015,1000,1073741825];
[9,5,-672440707,0];
function f9() {
    return v3;
}
...
try {
    ...
    try { v88["max"]("max", "max", F17); } catch (e) {}
    new WeakSet(4087n);
} catch(e95) {
} finally {
}
