...
new F14(948, 948, 1000);
new F14(1000, 1552, 1000);
const v21 = new F14(948, 1000, 1552);
const v23 = [4294967297,128,55693,7146,15,64,1,9007199254740992,15,1024];
new Uint8Array(v23, v23);
class C26 {
    constructor(a28) {
        try { a28(Set, Set, ...a28); } catch (e) {}
    }
}
function f32() {
    return 41221n;
}
("function")["substring"](1552, v21);
const v39 = new resourceName(512);
new Int16Array(447);
