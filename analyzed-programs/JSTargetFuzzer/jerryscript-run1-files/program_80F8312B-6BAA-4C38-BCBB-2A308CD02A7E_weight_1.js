...
function F4(a6, a7) {
    ...
    return v10;
    const t6 = [1e-15,-411070.39635269647,0.22903446810738004,-0.9489137449519625,1.3382316145795576e+308,7.409496107698487,-966.7686753242056,1000.0,5.0];
    t6[8] |= -1;
    this.h = v3;
    this.e = WeakSet;
    this.c = a6;
}
const v13 = new F4(v3, v1);
const v14 = new F4(v13, WeakSet);
new F4(v1, v3);
class C16 {
