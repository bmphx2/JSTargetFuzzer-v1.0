...
new F3(12);
const v7 = new F3(-268435456);
new F3(-268435456);
const v10 = (a11, a12, a13, a14) => {
    a13 == 127;
    return a13;
};
const v16 = [-638.2241493187506];
[5.0,-199.58172254619728,79.18702390418775,-6.48837774844322e+306,1e-15,1000000000000.0];
[-0.8304394312025991,-3.0,0.1374897811701674,916208.4789415775,-1e-15,9.471618339124703,-3.984482410447278e+307];
const v24 = new Uint8Array(512);
new Int16Array(447);
let v29 = -1582169311;
v7 - v29--;
v16.copyWithin([-2.24874475395427], 987924842);
...
for (let v63 = 0; v63 < 5; v63++) {
    Object.defineProperty(v62, 536870888, { enumerable: true, set: v10 });
}
...
class C93 {
    getUTCDay(a95, a96) {
        a96(a95, a96, a95, a96, -7.723443359121103e+307);
    }
}
new C93();
