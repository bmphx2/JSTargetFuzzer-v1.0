const v3 = [-27046,9007199254740992,-9007199254740992,10,-61318,9,-65535];
[-43543,41771223,-4096,9,24424,4294967296,-9334,11216,-4];
const v5 = [1262932434,-2,1877749757,-14,-1024,268435439,-37611,3,-7];
const v8 = -Infinity;
function F10(a12, a13, a14) {
    if (!new.target) { throw 'must be called with new'; }
    this.d = undefined;
    this.g = 1073741824;
    this.b = -414586.21338759747;
}
new F10(v8, v3, 1073741824);
new F10(v8, v5, -65535);
new F10(v8, v3, 1073741824);
