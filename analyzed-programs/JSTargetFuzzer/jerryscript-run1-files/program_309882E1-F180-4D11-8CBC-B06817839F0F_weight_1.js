...
class C9 {
    ...
    static toString(a11, a12) {
        this.__proto__ = v8;
        v8[a11] *= a12;
        [-2147483649,-1,10,1073741824,-18774,2147483647];
        [128,1,9007199254740990,4294967296,23608,2,9007199254740992,24425,1071231772,9];
        [268435456,-11,-128,-5,1419371221,-1539999055];
        return v8;
    }
}
new C9();
...
const v44 = v43.copyWithin(v43, v43);
("1073741824").match(v44);
new Uint8Array(0);
