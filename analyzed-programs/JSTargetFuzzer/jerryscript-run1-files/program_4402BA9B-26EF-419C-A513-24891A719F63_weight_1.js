const v0 = [-59784];
const v1 = [12656,536870888,8,316316544,10];
const v2 = [572166888,-4096,-55975,536870888,536870912];
function F9(a11, a12, a13) {
    if (!new.target) { throw 'must be called with new'; }
    this.c = a11;
}
new F9(24866, v0, 54985);
const v15 = new F9(-4, v2, v0);
new F9(4, v1, v15);
