let v0 = -647324.6713625886;
let v4 = new Date();
function F5(a7) {
    if (!new.target) { throw 'must be called with new'; }
    this.d = a7;
}
const v8 = new F5(264302.03191804397);
const v9 = new F5(264302.03191804397);
const v10 = new F5(-6.375587549631616);
new Float32Array(3701);
v4 = v8;
v10.d;
const v18 = Date(-1);
delete v18[9];
Object.defineProperty(v4, 1073741824, { configurable: true, set: Date });
