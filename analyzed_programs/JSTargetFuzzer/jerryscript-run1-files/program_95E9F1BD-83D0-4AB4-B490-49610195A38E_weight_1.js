new BigInt64Array(888);
new Float32Array(2739);
new Float32Array(1588);
function F12(a14, a15, a16) {
    if (!new.target) { throw 'must be called with new'; }
    this.f = 2n;
}
new F12(1588, 268435441n, 888);
new F12(888, 268435441n, 1588);
new F12(888, 268435439n, 888);
new Date();
function F34() {
    if (!new.target) { throw 'must be called with new'; }
