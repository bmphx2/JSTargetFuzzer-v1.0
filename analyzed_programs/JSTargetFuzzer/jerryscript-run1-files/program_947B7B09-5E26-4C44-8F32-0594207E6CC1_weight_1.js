const v0 = [38382];
const v1 = [17382,4,6,2,905426009];
const v2 = [256,-27653,536870889,14,878133666,25965,-9007199254740991,-40497,1681133095,1000];
const v4 = new Set();
const v6 = new Date();
const v7 = [v1,v0,Set];
[v6,Date,v1,v1];
const v9 = [v7,v4,v2];
[-40838,1000,0,1024,48816,64];
[-25323,1406904055,8,10000,-352704590,-2,4];
[27912529,-2147483648];
function f13() {
    return v9;
}
