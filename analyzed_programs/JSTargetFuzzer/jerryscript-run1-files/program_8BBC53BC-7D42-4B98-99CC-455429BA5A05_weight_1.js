[-128,4096,306835357,1924071194,1866612519,2147483649];
const v1 = [3,6,536870888,847423563,-53721,15,2147483649,1743132410,-15,2147483649];
const v2 = [65535];
function f3() {
    return v1;
}
...
let v50 = 0;
do {
    Object.defineProperty(v2, 127, { enumerable: true, get: f3 });
    v50++;
} while (v50 < 10)
function f55() {
