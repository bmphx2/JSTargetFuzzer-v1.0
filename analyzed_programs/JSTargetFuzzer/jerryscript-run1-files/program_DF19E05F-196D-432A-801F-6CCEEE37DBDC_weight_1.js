const v0 = [-1000.0,3.0];
const v1 = [1000.0,1000.0,19284.41796570609,104.47563741511635,1000000000.0,1000000000.0];
const v2 = [4.0,285.5616819659326];
const v7 = new Map();
const v8 = [-13,v7,v0,v7,16];
[v1,v8,v8,v8,Map];
[-13,14009,v1,v0,v8];
function F11() {
...
const v29 = `
    ...
    v25[Symbol.isConcatSpreadable] = v21;
`;
eval(v29);
