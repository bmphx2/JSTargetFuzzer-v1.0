class C6 {
    n(a8, a9) {
        ...
        switch (0.0) {
            default:
                new Uint16Array(257, 257);
                new Boolean(6);
                new Uint32Array(3450);
                break;
        }
        return 1000000000.0;
    }
