const v7 = Date();
const v8 = [-13,-465622521,22703];
const v9 = v8.slice();
new Date();
const v12 = [-1000000.0,11,-1.7976931348623157e+308];
v9.__proto__;
v9[8] = v7;
delete Date[3604326942];
Date >>> Date[2147483647];
const v18 = [-1000000.0,-1000000.0,[v12],-2.220446049250313e-16];
function f22() {
    return -5.854644440378005;
}
