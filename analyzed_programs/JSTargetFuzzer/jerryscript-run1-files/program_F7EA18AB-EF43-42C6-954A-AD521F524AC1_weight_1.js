...
new F9(255, 9007199254740992);
new F9(129, 9007199254740992);
new F9(268435439, 268435439);
new Date();
function F30() {
    if (!new.target) { throw 'must be called with new'; }
...
try {
    ...
    new C102();
    let v104 = [-29049,-2147483647,2147483648,-261208865,0,-9,11];
    let v107 = BigUint64Array;
    const v108 = new v107(12);
    let v109;
    try { v109 = v104(-4294967295); } catch (e) {}
    ({"buffer":v104,"d":v107,"g":v109,...v109} = v108);
} catch(e110) {
} finally {
    function f111() {
        return arguments;
