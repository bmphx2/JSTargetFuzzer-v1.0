...
new F9(F9, 174);
const v14 = new F9(v8, 1000);
const v15 = new F9(v2, 1000);
[174,Int32Array,v14,v15];
[[v8,BigInt64Array]];
new Date();
function F33() {
    if (!new.target) { throw 'must be called with new'; }
...
("42655").trimRight();
let v107 = 10;
for ([-3.0,1.7182266648454853e+308,331.02351975919237,-1e-15,-4.0,-3.0,-Infinity]; v107--;) {
}
...
while (v113 < 6) {
    let v116;
    try { v116 = v111.map(f40, v64); } catch (e) {}
    v116.valueOf = v116;
    try { f46(v38, ...14n, v14, v116); } catch (e) {}
    v113++;
}
