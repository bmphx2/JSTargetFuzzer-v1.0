...
const v3 = new F0();
const v4 = new F0();
([-11,-28972,65535,12,536870912,-2,536870889,50897,8]).includes(v4);
new Uint8ClampedArray([16,-36818,14,256]);
new F0();
function f11() {
    return v3;
}
[-1000000.0,-2.220446049250313e-16,-2.220446049250313e-16,Infinity,0.7238795847555284];
[0.85237978914565,1.169762507634017e+308,-1e-15];
[0.47745561942809034,1000000000000.0,1.880146737356398];
new WeakSet();
function f29() {
    return f29;
}
