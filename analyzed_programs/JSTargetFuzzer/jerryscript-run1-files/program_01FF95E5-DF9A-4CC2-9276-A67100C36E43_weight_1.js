[8,-8786,42641,4294967296,6];
[1,4,536870889,50174];
[-128,2,-1333174366,-128];
function f6() {
    return -12;
}
[-1248257660,1024];
const v8 = [-138894325,1073741825,15401,65537,127,11,-11];
[-4294967296,-2147483647,16,10,-65537,1452615902,127,1501665559,6];
const v11 = new Date();
function f12() {
    return v8;
}
...
v62 %= 268435440;
"m" * "function";
try { ("1073741824").trimRight(); } catch (e) {}
