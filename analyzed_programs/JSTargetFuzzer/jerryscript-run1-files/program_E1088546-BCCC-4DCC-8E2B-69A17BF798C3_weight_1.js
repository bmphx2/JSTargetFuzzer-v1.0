const v0 = [3,-588117456,12208,-4665,-65536,128];
[-1,268435441];
const v2 = [-399256595,268435456,2,0,10,-1395455445,-23689,1024,5];
let v3;
try { v3 = new v0(v2); } catch (e) {}
const v4 = v3 ^ v2;
-2000716461 ^ v4;
Math.atanh(v4);
const v10 = Math.log1p(-3.0);
new Float32Array(127);
new BigInt64Array(3876);
const v22 = async (a23, a24) => {
    a23[9] = v10;
    return await a24;
};
