...
const v6 = [3,65536,847807807,-16,-11,-34034,65536,10917,-16];
...
with (v17) {
    let v47 = a;
    let v49 = `rizPp${-9.899771639207565}number${v46}sticky${426.7417148362349}-29565${v47 || -1000000.0}atan2`;
    ({"length":v47,} = v49);
    v19 |= -1e-15;
    let v52 = -9;
    Math.round(8.62115359329939e+307);
    const v55 = v49++;
    v52++;
    Math.fround(v55);
    Math.sign(v52);
