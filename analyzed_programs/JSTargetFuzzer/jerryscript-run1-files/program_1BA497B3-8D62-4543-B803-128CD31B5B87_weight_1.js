...
function f1() {
    const o17 = {
        ...
        "b": f0,
        get d() {
            try { this.fromCharCode(f0, f0, this); } catch (e) {}
            const v4 = `
                f0 != v4;
...
f1();
f1();
[-29704,-9223372036854775807,13,257,9557,-65339,-13075];
[8,268435441];
const v26 = [1927499627,-15,127,-2147483648,956659532,42679];
function F33() {
...
const o61 = {
    ...
    "has": f0,
    "isExtensible": f0,
    "MAX_SAFE_INTEGER": f40,
    "preventExtensions": f40,
    "toStringTag": f1,
};
new Proxy(RegExp, o61);
let v64 = 1073741824n;
v64 &= v64;
try { Float32Array(); } catch (e) {}
(-12n).toString();
([-63514,-72509524,2147483647,-256,1966773057])["map"](Array, v36);
new Float64Array(16);
class C78 {
}
const v80 = new v53(1);
