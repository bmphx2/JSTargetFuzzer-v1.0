...
function f78(a79, a80, a81, a82) {
    ...
    const o119 = {
        ...
        set f(a109) {
            v77[this] = a81;
            let v110;
            try { v110 = this.m(-4096, 0); } catch (e) {}
            ({"a":v110,} = this);
            [257,536870888];
            [65536,9,1724,37005,-65535,-14,-14,2,4096,5];
            const v114 = Date.__proto__;
            ("reverse").matchAll(v114);
            v114();
...
const v120 = f78(858, 255, 255, v67);
const v121 = f78(-4096, 255, 858, v77);
f78(255, 255, -4096, 255);
v120[8] |= 7;
for (const v123 in v74) {
    const v125 = [v123,f78,255];
    Reflect.apply(v121.m, v77, v125);
    function f128() {
        return v123;
    }
}
