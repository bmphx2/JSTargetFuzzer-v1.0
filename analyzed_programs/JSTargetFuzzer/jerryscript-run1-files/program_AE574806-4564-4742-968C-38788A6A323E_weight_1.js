let v0 = 10000;
[-659043045,1,512];
[-34556,5,7,-536870912,10];
const v5 = [-1658978390,16,-4294967297,536870888,-223614568,1,4096];
class C6 {
    static valueOf(a8, a9, a10) {
        v5[9];
        try { v5.copyWithin(v0, 4294967297, 65537); } catch (e) {}
        new BigInt64Array(1363);
        new Int32Array(12);
        new Uint16Array(2);
        return v0;
    }
...
v64 -= v0;
v45.length;
v53["reverse"](...v53, ..."reverse", ...v41, o48);
new BigInt64Array(7);
